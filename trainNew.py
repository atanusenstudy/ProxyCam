...
window.title("ProxyCam: Smart-Attendance-System")
...
window.configure(background='#00b3b3')
...
#button_back=PhotoImage(file="button.png")
...
#Prof. Sunita Agarwal
#Mini Project 1 (SRS and Design)(CS34601)
tt="Atanu Sen(2018CA87)\nUnder the guidance of:-\nProf. Sunita Agarwal\nMini Project 1 (SRS and Design)(CS34601)"
lbl3 = tk.Label(window, text=tt,width=32  ,fg="white"  ,bg="#00b3b3"  ,height=6 ,font=('times', 15, '  underline'))
lbl3.place(x=850, y=460)
